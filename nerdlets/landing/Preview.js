...
class Preview extends React.Component {
  ...
  render() {
    ...
    /* to={`/view/${this.props.quickstart.id}`} */
    return (
      <GridItem columnSpan={3}>
        <Link className="preview-item" to={navigation.getOpenStackedNerdletLocation({ id: 'viewer', urlState: { dashboardId: this.props.quickstart.id }})}>
          <Card>
            <CardHeader
