        ...
        switch (source) {
          ...
          case 'SyntheticCheck':
            data = {
              ...
              url:
                'https://docs.newrelic.com/docs/synthetics/new-relic-synthetics/getting-started/introduction-new-relic-synthetics',
            };
            break;
          case 'Transaction':
          ...
          case 'MobileRequest':
            data = {
              ...
              url:
                'https://docs.newrelic.com/docs/mobile-monitoring/new-relic-mobile/get-started/introduction-mobile-monitoring',
            };
            break;
          ...
          case 'Prometheus':
            data = {
              ...
              url:
                'https://docs.newrelic.com/docs/integrations/prometheus-integrations/install-configure/install-update-or-uninstall-your-prometheus-openmetrics-integration',
            };
            break;
          case 'Log':
            data = {
